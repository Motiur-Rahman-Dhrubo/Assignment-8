            ...
            <div className='w-full bg-[#F7F7F7]'>
                <div className='bg-[#9538E2] w-11/12 py-8 mx-auto h-[500px] rounded-b-2xl'>
                    ...
                    <div className='flex justify-center gap-6 mt-4'>
                        <a href="#shopNow" className='bg-white text-[#9538E2] font-bold text-xl p-[15px_30px] rounded-full hover:bg-[#D9D9D9]'>Shop Now</a>
                        <Link to="/dashboard" className='bg-white text-[#9538E2] font-bold text-xl p-[15px_30px] rounded-full hover:bg-[#D9D9D9]'>Dashboard</Link>
                    </div>
                </div>
