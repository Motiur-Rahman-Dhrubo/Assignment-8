                    ...
                    <div className="p-8 rounded-2xl bg-white flex gap-8 items-center">
                        ...
                        <div className="w-9/12">
                            <div className="flex justify-between">
                                ...
                                <button onClick={() => removeToWishList()}><RxCrossCircled className="text-3xl text-[#FF0000]"/></button>
                            </div>
                            ...
                            <button className="bg-[#9037D9] font-medium text-lg text-white rounded-full p-[13px_26px] mt-4">Add to Card</button>
                        </div>
                    </div>
                ))}
            </div>
